...
// Load custom styles and scripts for the AVB Chat Widget (Paso 3.1)
function avb_enqueue_chat_assets() {
    $theme_uri = get_stylesheet_directory_uri();
    
    // Load CSS (Styles for the floating widget and chat window)
    wp_enqueue_style( 'avb-chat-style', $theme_uri . '/assets/avb-chat.css', array(), '1.0' );
    ...
    wp_localize_script( 'avb-chat-logic', 'avb_rest_params', array(
        ...
        'nonce'    => wp_create_nonce( 'wp_rest' ), // Create the Nonce security token
    ) );
}
